...
public class JDrawingCanvas extends JComponent implements DrawingCanvas {
    ...
    private double loupeSize = 30.0;
    private double loupeZoom = 3.0;
    ...
    private void repaintBuffer() {
        if (this.needsRepainting) {
            ...
            if (this.loupe != null) {
                Ellipse2D loupeArea = new Ellipse2D.Double(this.loupe.getDoubleX() - this.loupeZoom * this.loupeSize / 2.0, this.loupe.getDoubleY() - this.loupeZoom * this.loupeSize / 2.0, this.loupeZoom * this.loupeSize, this.loupeZoom * this.loupeSize);
