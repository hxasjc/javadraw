    ...
    public Shape makeShape2() {
        ...
        if (this.regular) {
            ...
            for(int i = 0; i < this.numSides; ++i) {
                locations.add(new Location((double)radius * Math.sin(6.283185307179586 / (double)this.numSides * (double)i), (double)radius * Math.cos(6.283185307179586 / (double)this.numSides * (double)i)));
            }
            ...
            while(var12.hasNext()) {
                Location point = (Location)var12.next();
        ...
        java.awt.Polygon poly = new java.awt.Polygon();
        Iterator var20 = points.iterator();

        while(var20.hasNext()) {
            Location l = (Location)var20.next();
            poly.addPoint(l.getX(), l.getY());
        }
